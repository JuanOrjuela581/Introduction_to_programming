        ...
        for (counter = 0; counter < p_notes.length; counter++) {
            ...
            for (counter = 0; counter < p_notes.length; counter++) {
                ...
                if (counter == 0){
                    ...
                    System.out.println("The percent for this qualification is: "+ 0.1*100 + " %");
                    System.out.println("The percent of the qualification number" + (counter + 1) + " is: " + (p_notes[counter] * 0.1));
                    System.out.println("---------------------------------------------------------");
                }
                else if (counter == 1) {
                    System.out.println("---------------------------------------------------------");
                    ...
                    System.out.println("---------------------------------------------------------");
                    System.out.println("The value of the qualification number " + (counter + 1) + " is: " + (p_notes[counter]));
                    System.out.println("The percent for this qualification is: "+  v_percent * 100 + " %");
                    System.out.println("The percent of the qualification number" + (counter + 1) + " is: " + (p_notes[counter] * v_percent));
                    System.out.println("---------------------------------------------------------");
                }
